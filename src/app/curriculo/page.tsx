								...
								<div className="flex h-full flex-col rounded-[20px] border border-border bg-card px-4 py-4 shadow-[0_1px_0_rgba(0,0,0,0.02)] sm:px-5 sm:py-5">
									<div className="flex items-center gap-3">
										...
										<div className="min-w-0">
											...
											<p className="mt-1 break text-[0.98rem] font-medium tracking-[-0.02em] text-foreground">
												{item.value}
											</p>
										</div>
									</div>
					...
					<div className="mt-10 grid gap-4">
						...
						<div className="grid gap-4 lg:grid-cols-2">
							{skillGroups.map((group) => (
								...
								>
									<h3 className="text-[1.12rem] font-semibold tracking-[-0.03em] text-foreground/90 dark:text-foreground/72">
										{group.title}
									</h3>
